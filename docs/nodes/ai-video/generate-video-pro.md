...
Short and Long preserve their planned source boundaries at delivery: experimental overlap anchors, word cuts, and smart-cut trimming do not move those boundaries. Max and legacy explicit-duration requests retain their existing trimming behavior.

...
| [Character Motion](./parameters/character-motion.md) | Pick what the subject does across the clip (1003 moves, 20 categories), up to 3 in order, with target and partner name substitution | Choreograph entrances, gestures, dance, stunts, and two-person moves for a named character |

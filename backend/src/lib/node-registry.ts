...
const RAW_NODE_REGISTRY: NodeDescriptor[] = [
  ...
  { type: "character-motion",     label: "Character Motion",     category: "parameter", description: "Pick what the subject does across the clip (1003 moves, 20 categories — entrances, turns, head and hand gestures, walks, runway, dance, expressions, camera interaction, stylized combat, athletics, falls, posture, everyday actions, vehicles, animals, two-person moves, idle life, stage, uncanny). Up to 3 ordered picks joined with \"then\", with position/pace timing. `target` names the subject and `partner` the second person. Emits a subject-bound prompt fragment via the cinematography handle.", outputType: "text" },
